...
let playerData = null;
let savePlayerDataNow = null;
let getPlayerMoney = null;
let reducePlayerMoney = null;
let addPlayerMoney = null;
let getCurrencyName = null;
let openMainMenu = null;
let t = null;
let getPlayerSetting = null;
let getSystemLanguage = null;
...
function init(deps) {
    ...
    savePlayerDataNow = deps.savePlayerDataNow;
    getPlayerMoney = deps.getPlayerMoney;
    reducePlayerMoney = deps.reducePlayerMoney;
    addPlayerMoney = deps.addPlayerMoney;
    getCurrencyName = deps.getCurrencyName;
    openMainMenu = deps.openMainMenu;
    t = deps.t;
    getPlayerSetting = deps.getPlayerSetting;
    getSystemLanguage = deps.getSystemLanguage;
}
